        ...
        public Task<PaymentGatewayResult> ThreeDGatewayRequest(PaymentGatewayRequest request)
        {
            try
            {
                ...
                var parameters = new Dictionary<string, object>
                {
                    ...
                    { "Currency", request.CurrencyIsoCode },//TL ISO code | EURO 978 | Dolar 840
                    ...
                    { "CartType", request.CardType },//kart tipi visa 1 | master 2 | amex 3
                    { "SecureType", secureType },
                    { "Lang", request.LanguageIsoCode.ToUpper() }//iki haneli dil iso kodu
                };
